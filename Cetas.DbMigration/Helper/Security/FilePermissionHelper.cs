...
namespace Cetas.DbMigration.Helper.Security;
...
public static class FilePermissionHelper
{
    ...
    [SupportedOSPlatform("windows")]
    private static bool CheckPermissionsInWindows(ICetasFileProvider fileProvider, string path, bool checkRead, bool checkWrite, bool checkModify, bool checkDelete)
    {
    ...
    /// <param name="checkDelete">Check delete</param>
    /// <returns>Result</returns>
    public static bool CheckPermissions(this ICetasFileProvider fileProvider, string path, bool checkRead, bool checkWrite, bool checkModify, bool checkDelete)
    {
    ...
    /// </summary>
    /// <returns>Result</returns>
    public static IEnumerable<string> GetDirectoriesWrite(this ICetasFileProvider fileProvider)
    {
    ...
    /// </summary>
    /// <returns>Result</returns>
    public static IEnumerable<string> GetFilesWrite(this ICetasFileProvider fileProvider)
    {
        return new List<string>
        {
            fileProvider.MapPath(CetasConfigurationDefaults.AppSettingsFilePath)
        };
    }
