...
using Cetas.DbMigration.Data.Mapping.Builders;
...
namespace Cetas.DbMigration.Data.Extensions
{
    /// <summary>
    ...
    public static class FluentMigratorExtensions
    {
        ...
        public static void RetrieveTableExpressions(this CreateTableExpressionBuilder builder, Type type)
        {
            ...
            if (typeFinder != null)
            {
                (new CetasEngine().ResolveUnregistered(typeFinder) as IEntityBuilder)?.MapEntity(builder);
            }
