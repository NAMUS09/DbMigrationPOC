...
/// </summary>
public partial class CetasDbStartup : ICetasStartup
{
    /// <summary>
    ...
    public void ConfigureServices(IServiceCollection services, IConfiguration configuration)
    {
        ...
        services
            // add common FluentMigrator servicess
            ...
            .AddSingleton<IConventionSet, CetasConventionSet>()
            .AddTransient(x => (IMappingEntityAccessor)x.GetRequiredService<IDataProviderManager>().DataProvider)
